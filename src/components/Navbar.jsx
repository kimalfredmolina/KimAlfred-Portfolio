      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex-1 flex justify-center items-center space-x-12 text-lg">
            ...
            <a href="#" className="hover:text-green-500 font-bold duration-300">Experience</a>
            <a href="#" className="hover:text-green-500 font-bold duration-300">Projects</a>
            <a href="#" className="hover:text-green-500 font-bold duration-300">Contact</a>
          </div>
        </div>
      </div>
    </div>
