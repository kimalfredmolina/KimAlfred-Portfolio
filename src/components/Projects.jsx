...
const Projects = () => {
  const projects = [
    ...
    {
        image: icon6 ,
        title: 'Voice Recognition Using Python',
    ...
    },
    {
        ...
        description: 'Simple Philippines Travel Blog website, showcasing beautiful and most tourist attractions in the Philippines.',
        icons: [ icon7, icon8 ],
